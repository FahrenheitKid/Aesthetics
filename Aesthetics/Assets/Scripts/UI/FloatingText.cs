...
public class FloatingText : MonoBehaviour
{
    ...
    public List<GameObject> m_floatingTextList;
    private GameObject m_current_floatingText;
    ...
    //}
    public void SpawnText (string tex, Color col, Vector3 pos)
    {
        m_textMeshPro.rectTransform.sizeDelta = new Vector2 (3, 1);
        ...
        //if( gameObject.GetComponent<Renderer>().material.shader.name == "2TintSquareVertexShader")
        m_textMeshPro.color = col;

        m_textMeshPro.fontSize = fontSize;
        //m_textMeshPro.enableExtraPadding = true;
        //m_textMeshPro.enableShadows = false;
        m_textMeshPro.text = tex;
        isDone = false;
    ...
    {
        float CountDuration = duration; // How long is the countdown alive.    
        float starting_Count = 1.0f; // At what number is the counter starting at.
        float current_Count = starting_Count;

        Vector3 start_pos = start_position;
        ...
        while (current_Count > 0)
        {
            ...
            //m_textMeshPro.SetText(score.ToString());

            m_textMeshPro.color = new Color32 (start_color.r, start_color.g, start_color.b, (byte) alpha);

            // Move the floating text upward each update
            transform.position += new Vector3 (0, starting_Count * Time.deltaTime, 0);
        ...
        // StartCoroutine(DisplayTextMeshProFloatingText(score));

        isDone = true;
        grid_ref.floatingTextList.Remove (this);
