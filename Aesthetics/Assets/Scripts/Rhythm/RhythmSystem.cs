...
public class RhythmSystem : MonoBehaviour {
	...
	#region Fields
		...
		Queue<RhythmNote> trackedNotes = new Queue<RhythmNote>();
		...
		public void CheckNoteHit()
		{
			...
			{
				RhythmNote hitNote = trackedNotes.Dequeue();
		...
		void CheckSpawnNext()
		{
			       ...
			       beatEvents[pendingEventIdx].StartSample < currentTime + samplesToTarget)
			{
				...
				RhythmNote newObj = GetFreshNoteObject();
				...
				{
					RhythmNote newObj2 = GetFreshNoteObject();
